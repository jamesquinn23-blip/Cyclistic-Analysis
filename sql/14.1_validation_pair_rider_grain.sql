...
-- Expected result: zero rows; every directed-pair/rider-type group occurs once.
...
SELECT
  ...
  end_station,
  ride_type,
  COUNT(*) AS rows_per_pair_rider_type
FROM output
GROUP BY start_station, end_station, ride_type
HAVING COUNT(*) <> 1
