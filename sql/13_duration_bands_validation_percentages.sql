...
--- Duration band percent validation: Should sum to 100% with negligible floating-point imprecision
SELECT
  day_of_the_week_started_on,
  member_casual,
  SUM(duration_band_percent)
FROM output
GROUP BY day_of_the_week_started_on, member_casual;
